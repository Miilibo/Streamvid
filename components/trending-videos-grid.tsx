...
export default function TrendingVideosGrid() {
  ...
  // Load trending videos from localStorage
  useEffect(() => {
    ...
    const interval = setInterval(loadTrendingVideos, 1000)
  ...
  if (trendingVideos.length === 0) {
    return (
      <div className="text-center py-12">
        <TrendingUp className="w-16 h-16 mx-auto mb-4 text-zinc-400" />
        <h3 className="text-lg font-medium text-white mb-2">No trending videos curated yet</h3>
